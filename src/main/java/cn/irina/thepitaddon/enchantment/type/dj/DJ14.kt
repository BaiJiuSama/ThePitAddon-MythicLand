...
@ArmorOnly
class DJ14 : AbstractEnchantment(), ITickTask, MovementHandler {

    private val playerMap: MutableMap<UUID, PositionSongPlayer> = HashMap()
    private val music: Song = NBSDecoder.parse(instance.javaClass.getClassLoader().getResourceAsStream("GirlsBandCry.nbs"))
    ...
    override fun getRarity(): EnchantmentRarity {
        return EnchantmentRarity.valueOf("OP")
    }
    ...
    override fun getUsefulnessLore(enchantLevel: Int): String {
        return ("&7此附魔只能通过 &e抽奖活动 &7获得." + "/s&7向周围的玩家播放音乐: &f雑踏, 僕らの街")
    }
