...
@ArmorOnly
class DJ17 : AbstractEnchantment(), ITickTask, MovementHandler {

    private val playerMap: MutableMap<UUID, PositionSongPlayer> = HashMap()
    private val music: Song = NBSDecoder.parse(instance.javaClass.getClassLoader().getResourceAsStream("RushE.nbs"))
