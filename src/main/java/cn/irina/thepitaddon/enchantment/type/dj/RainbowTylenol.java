...
@ArmorOnly
public class RainbowTylenol extends AbstractEnchantment implements  ITickTask, MovementHandler {
    ...
    public RainbowTylenol() {
        this.music = NBSDecoder.parse(ThePitAddon.getInstance().getClass().getClassLoader().getResourceAsStream("RainbowTylenol.nbs"));
        new BukkitRunnable() {
            @Override
            public void run() {
